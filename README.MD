...
Also add the `upload-keystore.jks` file and `secrets.gradle` to 1pw. This is important because the secrets cannot be read by any user in github, only by the CI system.
