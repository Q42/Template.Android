...
1. Some stubs have been added, which require eg. a Firebase project to be configured before they 
   can be used. Crashlytics, for example. Search the project for TODO comments to find them. 
